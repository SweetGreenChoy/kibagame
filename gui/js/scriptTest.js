//Socket
/* 
var roomCode = document.getElementById("root").getAttribute("room_code");
var char_choice = document.getElementById("root").getAttribute("char_choice");
...
function createGrid(boardSize) {
  ...
  for (var i = 0; i < boardSize; i++) {
    $(".board_inner").append('<div class="row" id="row-' + i + '">');
